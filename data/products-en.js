...
window.SITE = {
  ...
  claim: "Targeted wellbeing,\nessential formulas.",
  claimHighlight: ".",
  heroText:
    "Stilo Lab develops food supplements with selected ingredients and essential formulas, to be with you every day in your natural wellbeing.",
  formulesTitle: "Our formulas, designed for your balance.",
  formulesSub: "Food supplements with selected ingredients and essential formulas.",
  ...
  address: "Farmacia Stilo, Via San Giovanni 32, 25080 Moniga del Garda (BS), Italy"
};
...
window.PRODUCTS = [
...

  {
    ...
    benefici: [
      ...
      "Contributes to normal psychological function and to normal haematopoiesis",
    ...
    ingredientiTabella: [
      ...
      { nome: "Thiamine (vit. B1)", quantita: "12.2 mg (1109% NRV*)" },
      { nome: "Vitamin B6 (pyridoxine)", quantita: "4.8 mg (343% NRV*)" },
      { nome: "Folate (Quatrefolic® 5-MTHF)", quantita: "216 µg (108% NRV*)" },
      { nome: "Vitamin D (cholecalciferol)", quantita: "50 µg (1000% NRV*)" },
      { nome: "Vitamin B12 (cyanocobalamin)", quantita: "10 µg (400% NRV*)" }
    ],
    // Verify the NRV percentages.
    dosiRiferite: "per daily dose (1 tablet) — *NRV: Nutrient Reference Values",
    modoUso:
...

  {
    ...
    // Verify format, dosages and ingredients.
    format: "30 tablets",
    weight: "33 g",
    price: "18.50",
    ...
    quando: ["A feeling of heavy legs", "In case of haemorrhoids", "Long days on your feet or at a desk", "Periodic cycles in the warm months"],
    ...
    dosiRiferite: "Typical content per tablet.",
    modoUso:
      "One to two tablets a day with a glass of water.",
    avvertenze:
      "Do not exceed the recommended daily dose. Keep out of reach of children under 3 years of age. Food supplements are not intended as a substitute for a varied, balanced diet and a healthy lifestyle. During pregnancy and breastfeeding, seek the advice of your pharmacist or doctor. If you are undergoing drug treatment, in particular with anticoagulants, consult your doctor.",
    conservazione:
      "Store tightly closed in a cool, dry place, away from direct sunlight and heat sources. The expiry date refers to the product correctly stored in an intact pack.",
    ingredientiCompleti:
...

  {
    ...
    ingredientiTabella: [
      ...
      { nome: "of which magnesium", quantita: "300 mg (80% NRV*)" }
    ],
    dosiRiferite: "Typical content per daily dose (2 capsules) — *NRV: Nutrient Reference Values.",
    modoUso:
      "Two capsules a day with a glass of water, preferably during or after meals.",
    avvertenze:
      "Do not exceed the recommended daily dose. Keep out of reach of children under 3 years of age. Food supplements are not intended as a substitute for a varied, balanced diet and a healthy lifestyle. During pregnancy and breastfeeding, seek the advice of your pharmacist or doctor.",
    conservazione:
      "Store tightly closed in a cool, dry place, away from direct sunlight and heat sources. The expiry date refers to the product correctly stored in an intact pack.",
    ingredientiCompleti:
      "Magnesium bisglycinate; Coating agent (capsule shell): cellulose; Anti-caking agents: fatty acids, magnesium salts of fatty acids, silicon dioxide. Gluten free · Lactose free · Vegetable capsule, suitable for vegetarians and vegans."
  },

  {
    ...
    ingredientiTabella: [
      { nome: "L-glutamine", quantita: "5000 mg" }
    ],
    dosiRiferite: "Typical content per daily dose (1 sachet).",
    modoUso:
